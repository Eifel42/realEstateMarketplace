...
contract SolnSquareVerifier is ERC721Mintable {
    ...
    function mintNewToken(uint[2] memory a, uint[2][2] memory b, uint[2] memory c, uint[2] memory input, address to, uint256 tokenId) public returns (bool) {
        require(addSolution(a,  b,  c, input, to), "Unable to add the solution");
